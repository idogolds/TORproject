...
class NodeManager:
    ...
    def get_node_properties(self):
        with CONFIG_LOCK:
            ...
            node_properties = {
                "name":  config.get('properties', 'node-name'), 
                "ip_address": config.get('connection', 'ip'),
                "public_key": config.get('properties', 'RSA-public-key'),
            ...
            #for one device
            DB.insert_new_node(node_properties["name"], node_properties['ip_address'], node_properties["public_key"], node_properties["bandwidth"], node_properties["OP_port"], node_properties["user"], node_properties["flags"]) 
